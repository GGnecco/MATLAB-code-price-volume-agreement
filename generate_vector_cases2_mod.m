function [vector_cases2,extra_linear_constraints]=generate_vector_cases2_mod(k1,k2,k3,k4)
...
extra_linear_constraints_temp{7}=s_A_L-p_A_L;
extra_linear_constraints_temp{8}=s_A_H-p_A_H;

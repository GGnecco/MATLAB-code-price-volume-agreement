function conditional_P_scenario_Q_1_S_A=conditional_scenario_probability_char_Q_1_S_A(Q_1,Q_2,S_A,S_B,T,P_L,P_H,S_A_LL,S_A_LH,S_A_HL,S_A_HH,S_B_LL,S_B_LH,S_B_HL,S_B_HH)
...
%1)
if (strcmp(Q_1,'Q_L') && strcmp(S_A,'S_A_L'))
    possible_events=[1 2 5 6];
...
%2)
elseif (strcmp(Q_1,'Q_L') && strcmp(S_A,'S_A_H'))
    possible_events=[3 4 7 8];
    P_scenario_num=scenario_probability_char(Q_1,Q_2,S_A,S_B,T,P_L,P_H,S_A_LL,S_A_LH,S_A_HL,S_A_HH,S_B_LL,S_B_LH,S_B_HL,S_B_HH);
    P_scenario_den=sym(0);
    for k=1:size(possible_events,2)
        Q_1_temp{k}='Q_L';    
...
%3)
elseif (strcmp(Q_1,'Q_H') && strcmp(S_A,'S_A_L'))
    possible_events=[9 10 13 14];
    P_scenario_num=scenario_probability_char(Q_1,Q_2,S_A,S_B,T,P_L,P_H,S_A_LL,S_A_LH,S_A_HL,S_A_HH,S_B_LL,S_B_LH,S_B_HL,S_B_HH);
    P_scenario_den=sym(0);
    for k=1:size(possible_events,2)
        Q_1_temp{k}='Q_H';    
...
%4)
elseif (strcmp(Q_1,'Q_H') && strcmp(S_A,'S_A_H'))
    possible_events=[11 12 15 16];
    P_scenario_num=scenario_probability_char(Q_1,Q_2,S_A,S_B,T,P_L,P_H,S_A_LL,S_A_LH,S_A_HL,S_A_HH,S_B_LL,S_B_LH,S_B_HL,S_B_HH);
    P_scenario_den=sym(0);
    for k=1:size(possible_events,2)
        Q_1_temp{k}='Q_H';    
...
conditional_P_scenario_Q_1_S_A=P_scenario_num/P_scenario_den;

...
events={'Q_L','Q_L','S_A_L','S_B_L','p_A_H','s_A_H','p_B_LLL';
        'Q_L','Q_L','S_A_L','S_B_H','p_A_H','s_A_H','p_B_LLH';
        'Q_L','Q_L','S_A_H','S_B_L','p_A_L','s_A_L','p_B_LHL';
        'Q_L','Q_L','S_A_H','S_B_H','p_A_L','s_A_L','p_B_LHH';
        'Q_L','Q_H','S_A_L','S_B_L','p_A_H','s_A_H','p_B_LLL';
        'Q_L','Q_H','S_A_L','S_B_H','p_A_H','s_A_H','p_B_LLH';
        'Q_L','Q_H','S_A_H','S_B_L','p_A_L','s_A_L','p_B_LHL';
        'Q_L','Q_H','S_A_H','S_B_H','p_A_L','s_A_L','p_B_LHH';
        'Q_H','Q_L','S_A_L','S_B_L','p_A_H','s_A_H','p_B_HLL';
        'Q_H','Q_L','S_A_L','S_B_H','p_A_H','s_A_H','p_B_HLH';
        'Q_H','Q_L','S_A_H','S_B_L','p_A_L','s_A_L','p_B_HHL';
        'Q_H','Q_L','S_A_H','S_B_H','p_A_L','s_A_L','p_B_HHH';
        'Q_H','Q_H','S_A_L','S_B_L','p_A_H','s_A_H','p_B_HLL';
        'Q_H','Q_H','S_A_L','S_B_H','p_A_H','s_A_H','p_B_HLH';
        'Q_H','Q_H','S_A_H','S_B_L','p_A_L','s_A_L','p_B_HHL';
        'Q_H','Q_H','S_A_H','S_B_H','p_A_L','s_A_L','p_B_HHH'};

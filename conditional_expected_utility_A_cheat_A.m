function conditional_expected_utility_A_cheat_A=conditional_expected_utility_A_cheat_A(S_A,T,P_L,P_H,P_LL,P_LH,P_HL,P_HH,S_A_LL,S_A_LH,S_A_HL,S_A_HH,S_B_LL,S_B_LH,S_B_HL,S_B_HH,Q_L,Q_H,Q_TL,Q_TH,p_A,s_A,c_A,p_B,c_B,lambda,beta,cases1,vector_cases2)
...
vector_cases2_cheat_A{1}=vector_cases2{3};
vector_cases2_cheat_A{2}=vector_cases2{4};
vector_cases2_cheat_A{3}=vector_cases2{1};
vector_cases2_cheat_A{4}=vector_cases2{2};
vector_cases2_cheat_A{5}=vector_cases2{7};
vector_cases2_cheat_A{6}=vector_cases2{8};
vector_cases2_cheat_A{7}=vector_cases2{5};
vector_cases2_cheat_A{8}=vector_cases2{6};
vector_cases2_cheat_A{9}=vector_cases2{11};
vector_cases2_cheat_A{10}=vector_cases2{12};
vector_cases2_cheat_A{11}=vector_cases2{9};
vector_cases2_cheat_A{12}=vector_cases2{10};
vector_cases2_cheat_A{13}=vector_cases2{15};
vector_cases2_cheat_A{14}=vector_cases2{16};
vector_cases2_cheat_A{15}=vector_cases2{13};
vector_cases2_cheat_A{16}=vector_cases2{14};

events={'Q_L','Q_L','S_A_L','S_B_L','p_A_H','s_A_H','p_B_LHL','H';
        'Q_L','Q_L','S_A_L','S_B_H','p_A_H','s_A_H','p_B_LHH','H';
        'Q_L','Q_L','S_A_H','S_B_L','p_A_L','s_A_L','p_B_LLL','L';
        'Q_L','Q_L','S_A_H','S_B_H','p_A_L','s_A_L','p_B_LLH','L';
        'Q_L','Q_H','S_A_L','S_B_L','p_A_H','s_A_H','p_B_LHL','H';
        'Q_L','Q_H','S_A_L','S_B_H','p_A_H','s_A_H','p_B_LHH','H';
        'Q_L','Q_H','S_A_H','S_B_L','p_A_L','s_A_L','p_B_LLL','L';
        'Q_L','Q_H','S_A_H','S_B_H','p_A_L','s_A_L','p_B_LLH','L';
        'Q_H','Q_L','S_A_L','S_B_L','p_A_H','s_A_H','p_B_HHL','H';
        'Q_H','Q_L','S_A_L','S_B_H','p_A_H','s_A_H','p_B_HHH','H';
        'Q_H','Q_L','S_A_H','S_B_L','p_A_L','s_A_L','p_B_HLL','L';
        'Q_H','Q_L','S_A_H','S_B_H','p_A_L','s_A_L','p_B_HLH','L';
        'Q_H','Q_H','S_A_L','S_B_L','p_A_H','s_A_H','p_B_HHL','H';
        'Q_H','Q_H','S_A_L','S_B_H','p_A_H','s_A_H','p_B_HHH','H';
        'Q_H','Q_H','S_A_H','S_B_L','p_A_L','s_A_L','p_B_HLL','L';
        'Q_H','Q_H','S_A_H','S_B_H','p_A_L','s_A_L','p_B_HLH','L'};
...
if strcmp(S_A,'S_A_L')
    ...
    for k=1:size(possible_events,2)
        ...
        cases2{k}=vector_cases2_cheat_A{possible_events(k)};
...
conditional_expected_utility_A_cheat_A=conditional_expected_utility_objective_A;

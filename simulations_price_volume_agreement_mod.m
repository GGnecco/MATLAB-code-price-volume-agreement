...
for counter=1:size(A,2)
    ...
    f_num=eval(subs(f_temp,{lambda,beta,Q_L,Q_H,P_L,T_P_LL,T_P_HL,F_C_A,c_A,c_B},{0,0.8,2*10^6,5*10^6,0.5,0.7,0.3,10^7,10,1}));
    A_num=eval(subs(A_temp,{lambda,beta,Q_L,Q_H,P_L,T_P_LL,T_P_HL,F_C_A,c_A,c_B},{0,0.8,2*10^6,5*10^6,0.5,0.7,0.3,10^7,10,1}));
    b_num=eval(subs(b_temp,{lambda,beta,Q_L,Q_H,P_L,T_P_LL,T_P_HL,F_C_A,c_A,c_B},{0,0.8,2*10^6,5*10^6,0.5,0.7,0.3,10^7,10,1}));
...
optimal_participation_constraint_A_L=eval(subs(optimal_participation_constraint_A_L_temp,{lambda,beta,Q_L,Q_H,P_L,T_P_LL,T_P_HL,F_C_A,c_A,c_B},{0,0.8,2*10^6,5*10^6,0.5,0.7,0.3,10^7,10,1}))
optimal_participation_constraint_A_H=eval(subs(optimal_participation_constraint_A_H_temp,{lambda,beta,Q_L,Q_H,P_L,T_P_LL,T_P_HL,F_C_A,c_A,c_B},{0,0.8,2*10^6,5*10^6,0.5,0.7,0.3,10^7,10,1}))
optimal_participation_constraint_B_L_L_L=eval(subs(beta*optimal_participation_constraint_B_L_L_L_temp,{lambda,beta,Q_L,Q_H,P_L,T_P_LL,T_P_HL,F_C_A,c_A,c_B},{0,0.8,2*10^6,5*10^6,0.5,0.7,0.3,10^7,10,1}))
optimal_participation_constraint_B_L_H_L=eval(subs(beta*optimal_participation_constraint_B_L_H_L_temp,{lambda,beta,Q_L,Q_H,P_L,T_P_LL,T_P_HL,F_C_A,c_A,c_B},{0,0.8,2*10^6,5*10^6,0.5,0.7,0.3,10^7,10,1}))
optimal_participation_constraint_B_H_L_L=eval(subs(beta*optimal_participation_constraint_B_H_L_L_temp,{lambda,beta,Q_L,Q_H,P_L,T_P_LL,T_P_HL,F_C_A,c_A,c_B},{0,0.8,2*10^6,5*10^6,0.5,0.7,0.3,10^7,10,1}))
optimal_participation_constraint_B_H_H_L=eval(subs(beta*optimal_participation_constraint_B_H_H_L_temp,{lambda,beta,Q_L,Q_H,P_L,T_P_LL,T_P_HL,F_C_A,c_A,c_B},{0,0.8,2*10^6,5*10^6,0.5,0.7,0.3,10^7,10,1}))
optimal_incentive_compatibility_constraint_A_L=eval(subs(beta*optimal_incentive_compatibility_constraint_A_L_temp,{lambda,beta,Q_L,Q_H,P_L,T_P_LL,T_P_HL,F_C_A,c_A,c_B},{0,0.8,2*10^6,5*10^6,0.5,0.7,0.3,10^7,10,1}))
optimal_incentive_compatibility_constraint_A_H=eval(subs(beta*optimal_incentive_compatibility_constraint_A_H_temp,{lambda,beta,Q_L,Q_H,P_L,T_P_LL,T_P_HL,F_C_A,c_A,c_B},{0,0.8,2*10^6,5*10^6,0.5,0.7,0.3,10^7,10,1}))
